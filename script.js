document.getElementById('first-class-increase').addEventListener('click', function () {
    handleTicketChange('first-class', true);  // increasing the first class ticket value
})

document.getElementById('first-class-decrease').addEventListener('click', function () {
    handleTicketChange('first-class', false);  // decreasing the first class ticket value
})

document.getElementById('economy-increase').addEventListener('click', function () {
    handleTicketChange('economy', true);  // increasing the economy class ticket value
})

document.getElementById('economy-decrease').addEventListener('click', function () {
    handleTicketChange('economy', false);  // decreasing the economy class ticket value
})

document.getElementById('book-now').addEventListener('click', function () {
    document.getElementById('confirmation-area').style.display = 'flex';  // showing confirmation area
})

document.getElementById('cross-sign').addEventListener('click', function () {
    document.getElementById('confirmation-area').style.display = 'none';  // hiding confirmation area and reset all the values
